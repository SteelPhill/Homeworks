...
public static class MainMenu
{
    ...
    [StaticConsoleMenuCommand("Показать топ-3 студий с максимальным количеством игр")]
    public static async Task DisplayTopThreeStudiosWithMaxGames()
    {
        await using var context = new ApplicationContext();
        ...
        Console.WriteLine();
        studios.ForEach(s => Console.WriteLine($"Id: {s.Id} | Name: {s.Name} | GamesCount: {s.Games.Count}"));
    }

    [StaticConsoleMenuCommand("Показать студию с максимальным количеством игр")]
    public static async Task DisplayStudioWithMaxGames()
    {
        await using var context = new ApplicationContext();
        ...
        Console.WriteLine();
        Console.WriteLine($"Id: {studio!.Id} | Name: {studio.Name} | GamesCount: {studio.Games.Count}");
    }

    [StaticConsoleMenuCommand("Показать топ-3 самых популярных жанра по количеству игр")]
    public static async Task DisplayTopThreeGenresWithMaxGames()
    {
        await using var context = new ApplicationContext();
        ...
        Console.WriteLine();
        genres.ForEach(g => Console.WriteLine($"Id: {g.Id} | Name: {g.Name} | GamesCount: {g.Games.Count}"));
    }

    [StaticConsoleMenuCommand("Показать самый популярный жанр по количеству игр")]
    public static async Task DisplayGenreWithMaxGames()
    {
        await using var context = new ApplicationContext();
        ...
        Console.WriteLine();
        Console.WriteLine($"Id: {genre!.Id} | Name: {genre.Name} | GamesCount: {genre.Games.Count}");
    }

    [StaticConsoleMenuCommand("Показать топ-3 самых популярных жанра по количеству продаж")]
    public static async Task DisplayTopThreeGenresWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
        ...
        var genres = await context.Genres
            ...
            {
                Genre = g,
                GamesSoldCopies = g.Games.Sum(g => g.SoldCopies)
            })
            .OrderByDescending(x => x.GamesSoldCopies)
            .Take(3)
            .ToArrayAsync();

        Console.WriteLine();
        genres.ForEach(x => Console.WriteLine($"Id: {x.Genre.Id} | Name: {x.Genre.Name} | SoldCopies: {x.GamesSoldCopies}"));
    }

    [StaticConsoleMenuCommand("Показать самый популярный стиль по количеству продаж")]
    public static async Task DisplayGenreWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
        ...
        Console.WriteLine();
        Console.WriteLine($"Id: {genre!.Genre.Id} | Name: {genre.Genre.Name} | SoldCopies: {genre.GamesSoldCopies}");
    }

    [StaticConsoleMenuCommand("Показать топ-3 самых популярных однопользовательских игр по количеству продаж")]
    public static async Task DisplayTopThreeSingleGamesWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
    ...
    [StaticConsoleMenuCommand("Показать топ-3 самых популярных многопользовательских игр по количеству продаж")]
    public static async Task DisplayTopThreeNonSingleGamesWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
    ...
    [StaticConsoleMenuCommand("Показать самую популярную однопользовательскую игру по количеству продаж")]
    public static async Task DisplaySingleGameWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
    ...
    [StaticConsoleMenuCommand("Показать самую популярную многопользовательскую игру по количеству продаж")]
    public static async Task DisplayNonSingleGameWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
    ...
    [StaticConsoleMenuCommand("Показать самую популярную игру по количеству продаж")]
    public static async Task DisplayGameWithMaxSoldCopies()
    {
        await using var context = new ApplicationContext();
    ...
    [StaticConsoleMenuCommand("Удалить все игры с количеством продаж равным нулю")]
    public static async Task DeleteGamesWithZeroSoldCopies()
    {
        await DeleteGamesBySoldCopiesNumber(0);
    }

    [StaticConsoleMenuCommand("Удалить все игры с количеством продаж равным введенному")]
    public static async Task DeleteGamesWithSoldCopiesEqualEntered()
    {
        Console.WriteLine();
        var value = ConsoleReadHelper.ReadInt("Введите значение => ");

        await DeleteGamesBySoldCopiesNumber(value);
    }
    ...
    private static async Task DeleteGamesBySoldCopiesNumber(int soldCopiesNumber)
    {
        await using var context = new ApplicationContext();
        ...
        var games = await context.Games
            ...
            .Where(g =>
                ...
                !g.Genre.IsDeleted &&
                !g.Studio.IsDeleted &&
                g.SoldCopies == soldCopiesNumber)
            .ToArrayAsync();

        Console.WriteLine();
        Console.Write($"Игры с количеством продаж равным {soldCopiesNumber}:");
        Console.WriteLine();
        games.ForEach(PrintGame);

        Console.WriteLine();
        Console.Write("Удалить игры?");
        ConsoleMenuHelper.PrintCommands(["Да"]);
        var selector = ConsoleReadHelper.ReadInt(" => ", 0, 1);
        if (selector == 0)
            return;

        games.ForEach(g => g.IsDeleted = true);
        await context.SaveChangesAsync();

        Console.WriteLine();
        Console.WriteLine("Игры удалены.");
    }
