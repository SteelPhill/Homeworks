...
using Game2048.Services.MessageBox;
...
public class Locator : ILocatorService
{
	...
	private static void RegisterServices(IExportRegistrationBlock registration)
	{
        ...
        RegisterSingleton<IUserDB, UserDB>(registration);

        RegisterSingleton<IAuthorizationWindowProvider, AuthorizationWindowProvider>(registration);
